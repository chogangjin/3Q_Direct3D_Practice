...
public:
	...
	void DrawMesh(ID3D11DeviceContext* deviceContext)
	{
		...
		//deviceContext->UpdateSubresource(m_pConstantBuffer, 0, nullptr, &(*cbuffer), 0, 0);
		//deviceContext->UpdateSubresource(m_pBoneMatrixBuffer, 0, nullptr, &m_BoneOffsetMatrices, 0, 0);
		//deviceContext->VSSetConstantBuffers(0, 1, &m_pConstantBuffer);
		//deviceContext->VSSetConstantBuffers(3, 1, &m_pBoneMatrixBuffer);
