...
float4 main(PS_INPUT input) : SV_TARGET
{
    ...
    float mip = Rough * (currMipLevel-1);
    ...
    float3 indirectIBL = (diffuseIBL + specularIBL) /** NdotL * ambient*/;
    ...
    indirectIBL = indirectIBL * lightPower;
    
    //final
    float4 finalColor = 0;
    
    finalColor = float4(float3(directLight + emissive + indirectIBL ) , 1.0);
