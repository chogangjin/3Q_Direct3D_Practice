...
public:
	...
	void SetIrradianceMap (const std::wstring filepath);
	void SetEnvironmentMap(const std::wstring filepath);
	void SetPrefilteredMap(const std::wstring filepath);
	void SetLookUpTexture (const std::wstring filepath);
