...
public :
	...
	ComPtr<ID3D11DepthStencilState> m_pOutLineDepthStencilState = nullptr;

	ComPtr<ID3D11RasterizerState> m_pRasterizerState = nullptr;
	ComPtr<ID3D11RasterizerState> m_pOutLineRasterizerState = nullptr;
	...
	ComPtr<ID3D11ShaderResourceView> m_pRampTexture = nullptr;
