...
public:
	...
	void DrawHDRQuadDeffered(ID3D11DeviceContext* pDeviceContext, DXGI_FORMAT format, ID3D11ShaderResourceView* pShaderResourceView, ID3D11SamplerState* pSamplerState);
}; 
