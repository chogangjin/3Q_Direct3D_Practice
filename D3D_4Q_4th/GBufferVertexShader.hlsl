#include "Shared.fxh"
//VS_GBUFFER_OUTPUT main( VS_GBUFFER_INPUT input) 
//{
...
//    output.normalW = normalize(mul(input.normal, (float3x3) mworld));
//    output.TBN = 
//    float3x3(
//        normalize(mul(input.tangent, (float3x3) mworld)),
//        normalize(mul(input.binormal, (float3x3) mworld)),
//        normalize(mul(input.normal, (float3x3) mworld))
//    );
